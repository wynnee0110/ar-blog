            ...
            <div className="mt-3">
              {isEditing ? (
                <div className="flex flex-col gap-3 animate-in fade-in">
                  <input type="text" value={profile.full_name || ""} onChange={(e) => setProfile({ ...profile, full_name: e.target.value })} placeholder="Display Name" className="bg-gray-100 dark:bg-black/20 border border-gray-300 dark:border-gray-700 rounded-lg p-2 text-gray-900 dark:text-white font-bold text-xl outline-none" />
                  <input type="text" value={profile.username || ""} onChange={(e) => setProfile({ ...profile, username: e.target.value })} placeholder="Username" className="bg-gray-100 dark:bg-black/20 border border-gray-300 dark:border-gray-700 rounded-lg p-2 text-gray-600 dark:text-gray-400 text-sm outline-none" />
